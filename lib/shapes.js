...
class Triangle extends shapes {
    ...
    render() {
        ...
        <polygon points="100, 15 200, 200 0, 200" fill="${this.shapeColor}" stroke="black" stroke-width="2" />
...
class Circle extends shapes {
    ...
    render() {  
        return `<svg width="300" height="200" version="1.1" xmlns="http://www.w3.org/2000/svg">
        <circle cx="150" cy="100" r="100" fill="${this.shapeColor}" stroke="black" stroke-width="2" />
